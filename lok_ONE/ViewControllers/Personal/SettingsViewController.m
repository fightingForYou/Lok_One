...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.section == 0) {
        ...
        if ([[NSUserDefaults standardUserDefaults] boolForKey: APP_THEME_NIGHT_MODE]) {
            nightModeSwitch.on = [[NSUserDefaults standardUserDefaults] boolForKey: APP_THEME_NIGHT_MODE];
        } else {
...
- (void)nightModeSwitch:(UISwitch *)modeSwitch {
    if (modeSwitch.isOn) {
        ...
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey: APP_THEME_NIGHT_MODE];
    } else {
        ...
        self.tableView.backgroundColor = DawnViewBGColor;
        [[NSUserDefaults standardUserDefaults] setBool:NO forKey: APP_THEME_NIGHT_MODE];
    }
